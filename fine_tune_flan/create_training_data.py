...
if __name__ == "__main__":
    ...
    parser.add_argument('--queries_folder', type=str, default="/scratch/project/neural_ir/dylan/LLM_FS/data/fedwebgh/search_data/fedweb14/FW14-realquery-snippet", help='folder to get all the queries')
    parser.add_argument('--snippet_folder', type=str,
                        default="/scratch/project/neural_ir/dylan/LLM_FS/data/fedwebgh/search_data/fedweb14/FW14-sample-snippet",
                        help='folder to get all the queries')
    parser.add_argument('--engine_file', type=str, default='/scratch/project/neural_ir/dylan/LLM_FS/data/fedwebgh/meta_data/engines/FW14-engines.csv')
    parser.add_argument("--query_representation", type=str, default="name",
                        help="representation of the source, query or description")
    parser.add_argument("--query_description_input", type=str, default="/scratch/project/neural_ir/dylan/LLM_FS/generated_descriptions/description.jsonl", help="the input file for the query description")
